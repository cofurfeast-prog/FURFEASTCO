                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 max-w-3xl">
                        <div class="relative w-full">
                            ...
                            <form action="/search/" method="GET" class="w-full flex">
                                <input type="text" name="q" placeholder="Search products..."
                                    class="flex-1 pl-11 pr-4 py-2.5 rounded-l-full border border-slate-200 bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-sm">
                                <button type="submit" class="px-4 py-2.5 bg-primary text-white rounded-r-full hover:bg-primary-dark transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <circle cx="11" cy="11" r="8" />
                                        <path d="m21 21-4.3-4.3" />
