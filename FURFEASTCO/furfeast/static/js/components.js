        ...
        <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 py-3 sm:py-4">
            <div class="flex items-center justify-between gap-2">
                ...
                <div class="flex items-center gap-0.5 sm:gap-2">
                    ...
                    <!-- Profile -->
                    <a href="/profile/" class="hidden lg:block p-2 bg-primary hover:bg-green-700 rounded-full transition-colors text-white" aria-label="Profile">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 max-w-3xl">
                        <div class="relative w-full">
                            ...
                            <form action="/search/" method="GET" class="w-full flex">
                                <input type="text" name="q" placeholder="Search products..."
                                    class="flex-1 pl-11 pr-4 py-1.5 rounded-l-full border border-slate-200 bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-sm">
                                <button type="submit" class="px-4 py-1.5 bg-primary text-white rounded-r-full hover:bg-primary-dark transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <circle cx="11" cy="11" r="8" />
                                        <path d="m21 21-4.3-4.3" />
                                    </svg>
                    ...
                    <!-- Profile - Mobile Only -->
                    <a href="/profile/" class="lg:hidden p-2 bg-primary hover:bg-green-700 rounded-full transition-colors text-white" aria-label="Profile">
                         <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    </a>
                </div>
            </div>
